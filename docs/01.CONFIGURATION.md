...
This option enables the use of malloc/free instead of the internal JJS allocator. This feature requires 32-bit compressed pointers, and is unsupported on 64-bit architectures.
This option is disabled by default.

| Options |                                              |
|---------|----------------------------------------------|
| C:      | `-DJJS_SYSTEM_ALLOCATOR=0/1`               |
| CMake:  | `-DJJS_SYSTEM_ALLOCATOR=ON/OFF`            |
