...
## jjs_synthetic_module_evaluate_cb_t
...
```c
typedef jjs_value_t (*jjs_synthetic_module_evaluate_cb_t) (const jjs_value_t synthetic_module);
```

- `synthetic_module` - a synthetic module
- return value
...
Creates a synthetic module with a list of exports. The initial state of the module is linked.

*Notes*:
- Returned value must be freed with [jjs_value_free](#jjs_value_free)
  when it is no longer needed.
- Native pointers can be used to assign private data to a synthetic module,
  see [jjs_object_set_native_ptr](#jjs_object_set_native_ptr)
...
```c
jjs_value_t
jjs_synthetic_module (jjs_synthetic_module_evaluate_cb_t callback,
                      const jjs_value_t * const exports_p,
                      size_t number_of_exports);
```

- `callback` - a [jjs_synthetic_module_evaluate_cb_t](#jjs_synthetic_module_evaluate_cb_t) callback
...
main (void)
{
  ...
  jjs_value_t native_module = jjs_synthetic_module (NULL, exports, 2);
...
- [jjs_module_link](#jjs_module_link)
- [jjs_module_evaluate](#jjs_module_evaluate)
- [jjs_synthetic_module_set_export](#jjs_synthetic_module_set_export)
...
```c
jjs_value_t
jjs_value_t jjs_synthetic_module_set_export (const jjs_value_t synthetic_module,
                                             const jjs_value_t export_name,
                                             const jjs_value_t value_to_set)
```

- `synthetic_module` - a synthetic module object.
- `export_name` - string identifier of the export.
...
main (void)
{
  ...
  jjs_value_t native_module = jjs_synthetic_module (NULL, &export, 1);

  jjs_value_t number = jjs_number (3.5);
  jjs_value_t value = jjs_synthetic_module_set_export (native_module, export, number);
  jjs_value_free (value);
  jjs_value_free (number);
...
- [jjs_synthetic_module](#jjs_synthetic_module)
