...
/**
 * Option bits for jerry_init_options_t.
 */
typedef enum
{
  JERRY_INIT_OPTION_NO_OPTS = 0, /**< no options passed */
  JERRY_INIT_OPTION_HAS_HEAP_SIZE = (1 << 0), /**< heap_size field is valid */
  JERRY_INIT_OPTION_HAS_GC_LIMIT = (1 << 1), /**< gc_limit field is valid */
  JERRY_INIT_OPTION_HAS_GC_MARK_LIMIT = (1 << 2), /**< gc_mark_limit field is valid */
  JERRY_INIT_OPTION_HAS_STACK_LIMIT = (1 << 3), /**< stack_limit field is valid */
  JERRY_INIT_OPTION_HAS_GC_NEW_OBJECTS_FRACTION = (1 << 4), /**< gc_new_objects_fraction field is valid */
  JERRY_INIT_OPTION_ALL = 0xFFFF,
} jerry_init_option_enable_feature_t;

/**
 * Various configuration options for jerry_init_ex().
 */
typedef struct
{
  uint32_t flags; /**< combination of jerry_parse_option_enable_feature_t values */
  uint32_t heap_size; /**< maximum global heap size in bytes. if 0, JERRY_GLOBAL_HEAP_SIZE define is used */
