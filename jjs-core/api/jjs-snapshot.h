...
} jjs_snapshot_header_t;

/**
 * JJS snapshot magic marker.
 */
#define JJS_SNAPSHOT_MAGIC (0x5952524Au)
...
typedef enum
{
  ...
  JJS_SNAPSHOT_HAS_REGEX_LITERAL = (1u << 0), /**< byte code has regex literal */
  JJS_SNAPSHOT_HAS_CLASS_LITERAL = (1u << 1), /**< byte code has class literal */
