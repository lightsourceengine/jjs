...
typedef enum
{
  JJS_STDOUT = 0, /**< platform io_stdout from context */
  JJS_STDERR = 1, /**< platform io_stderr from context */
} jjs_platform_io_stream_id_t;

bool jjs_wstream_new (jjs_context_t* context_p, jjs_platform_io_stream_id_t id, jjs_value_t* out);

bool jjs_wstream_from_buffer (jjs_wstream_buffer_state_t* buffer_p, jjs_encoding_t encoding, jjs_wstream_t* out);
bool jjs_wstream_from_id (jjs_context_t* context_p, jjs_platform_io_stream_id_t id, jjs_wstream_t* out);
...
bool jjs_stream_is_installed (jjs_context_t* context_p, jjs_platform_io_stream_id_t id);
void jjs_stream_flush (jjs_context_t* context_p, jjs_platform_io_stream_id_t id);
void jjs_stream_write_string (jjs_context_t* context_p, jjs_platform_io_stream_id_t id, jjs_value_t value, jjs_value_t value_o);
