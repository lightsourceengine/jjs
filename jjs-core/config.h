 ...
 */
#if (JJS_PLATFORM_API_IO_WRITE != 0) && (JJS_PLATFORM_API_IO_WRITE != 1) && (JJS_PLATFORM_API_IO_WRITE != 2)
#error "Invalid value for 'JJS_PLATFORM_API_IO_WRITE' macro."
#endif /* (JJS_PLATFORM_API_IO_WRITE != 0) && (JJS_PLATFORM_API_IO_WRITE != 1) && (JJS_PLATFORM_API_IO_WRITE != 2) */
#if (JJS_PLATFORM_API_IO_FLUSH != 0) && (JJS_PLATFORM_API_IO_FLUSH != 1) && (JJS_PLATFORM_API_IO_FLUSH != 2)
#error "Invalid value for 'JJS_PLATFORM_API_IO_FLUSH' macro."
#endif /* (JJS_PLATFORM_API_IO_FLUSH != 0) && (JJS_PLATFORM_API_IO_FLUSH != 1) && (JJS_PLATFORM_API_IO_FLUSH != 2) */
#if (JJS_PLATFORM_API_TIME_LOCAL_TZA != 0) && (JJS_PLATFORM_API_TIME_LOCAL_TZA != 1) && (JJS_PLATFORM_API_TIME_LOCAL_TZA != 2)
#error "Invalid value for 'JJS_PLATFORM_API_TIME_LOCAL_TZA' macro."
#endif /* (JJS_PLATFORM_API_TIME_LOCAL_TZA != 0) && (JJS_PLATFORM_API_TIME_LOCAL_TZA != 1) && (JJS_PLATFORM_API_TIME_LOCAL_TZA != 2) */
#if (JJS_PLATFORM_API_TIME_NOW_MS != 0) && (JJS_PLATFORM_API_TIME_NOW_MS != 1) && (JJS_PLATFORM_API_TIME_NOW_MS != 2)
#error "Invalid value for 'JJS_PLATFORM_API_TIME_NOW_MS' macro."
#endif /* (JJS_PLATFORM_API_TIME_NOW_MS != 0) && (JJS_PLATFORM_API_TIME_NOW_MS != 1) && (JJS_PLATFORM_API_TIME_NOW_MS != 2) */
#if (JJS_PLATFORM_API_TIME_SLEEP != 0) && (JJS_PLATFORM_API_TIME_SLEEP != 1) && (JJS_PLATFORM_API_TIME_SLEEP != 2)
#error "Invalid value for 'JJS_PLATFORM_API_TIME_SLEEP' macro."
#endif /* (JJS_PLATFORM_API_TIME_SLEEP != 0) && (JJS_PLATFORM_API_TIME_SLEEP != 1) && (JJS_PLATFORM_API_TIME_SLEEP != 2) */
#if (JJS_PLATFORM_API_PATH_CWD != 0) && (JJS_PLATFORM_API_PATH_CWD != 1) && (JJS_PLATFORM_API_PATH_CWD != 2)
#error "Invalid value for 'JJS_PLATFORM_API_PATH_CWD' macro."
#endif /* (JJS_PLATFORM_API_PATH_CWD != 0) && (JJS_PLATFORM_API_PATH_CWD != 1) && (JJS_PLATFORM_API_PATH_CWD != 2) */
#if (JJS_PLATFORM_API_PATH_REALPATH != 0) && (JJS_PLATFORM_API_PATH_REALPATH != 1) && (JJS_PLATFORM_API_PATH_REALPATH != 2)
#error "Invalid value for 'JJS_PLATFORM_API_PATH_REALPATH' macro."
#endif /* (JJS_PLATFORM_API_PATH_REALPATH != 0) && (JJS_PLATFORM_API_PATH_REALPATH != 1) && (JJS_PLATFORM_API_PATH_REALPATH != 2) */
#if (JJS_PLATFORM_API_FS_READ_FILE != 0) && (JJS_PLATFORM_API_FS_READ_FILE != 1) && (JJS_PLATFORM_API_FS_READ_FILE != 2)
#error "Invalid value for 'JJS_PLATFORM_API_FS_READ_FILE' macro."
#endif /* (JJS_PLATFORM_API_FS_READ_FILE != 0) && (JJS_PLATFORM_API_FS_READ_FILE != 1) && (JJS_PLATFORM_API_FS_READ_FILE != 2) */
