...
|| !(JJS_ANNEX_ESM)
ECMA_ERROR_DEF (ECMA_ERR_ESM_NOT_SUPPORTED, "ESM support is disabled")
...
#if JJS_BUILTIN_BIGINT && JJS_BUILTIN_JSON
ECMA_ERROR_DEF (ECMA_ERR_BIGINT_SERIALIZED, "BigInt cannot be serialized")
#endif /* JJS_BUILTIN_BIGINT && JJS_BUILTIN_JSON */
#if JJS_BUILTIN_CONTAINER
...
ECMA_ERROR_DEF (ECMA_ERR_EXPECTED_STRING_OR_UNDEFINED, "Expected a string or undefined")
...
ECMA_ERROR_DEF (ECMA_ERR_QUEUE_MICROTASK_NOT_SUPPORTED, "queueMicrotask is not supported")
...
#endif /* JJS_MODULE_SYSTEM */
#if JJS_BUILTIN_ARRAY
ECMA_ERROR_DEF (ECMA_ERR_ARRAY_CONSTRUCTOR_SIZE_EXCEEDED, "New array size exceed limit of 2^32 - 1")
#endif /* JJS_BUILTIN_ARRAY */
#if JJS_BUILTIN_PROXY
...
ECMA_ERROR_DEF (ECMA_ERR_CONVERT_BOOLEAN_TO_NUMBER, "Cannot convert a boolean value to a number")
#if JJS_BUILTIN_ARRAY
