...
JJS_STATIC_ASSERT (ECMA_TYPE___MAX <= ECMA_VALUE_TYPE_MASK, ecma_types_must_be_less_than_mask);

JJS_STATIC_ASSERT ((ECMA_VALUE_TYPE_MASK + 1) == (1 << ECMA_VALUE_SHIFT), ecma_value_part_must_start_after_flags);

JJS_STATIC_ASSERT (ECMA_VALUE_SHIFT <= JMEM_ALIGNMENT_LOG,
                     ecma_value_shift_must_be_less_than_or_equal_than_mem_alignment_log);

JJS_STATIC_ASSERT (sizeof (jmem_cpointer_t) <= sizeof (ecma_value_t),
                     size_of_jmem_cpointer_t_must_be_less_or_equal_to_the_size_of_ecma_value_t);

JJS_STATIC_ASSERT (sizeof (jmem_cpointer_t) <= sizeof (jmem_cpointer_tag_t),
                     size_of_jmem_cpointer_t_must_be_less_or_equal_to_the_size_of_jmem_cpointer_tag_t);

#ifdef ECMA_VALUE_CAN_STORE_UINTPTR_VALUE_DIRECTLY

/* cppcheck-suppress zerodiv */
JJS_STATIC_ASSERT (sizeof (uintptr_t) <= sizeof (ecma_value_t), uintptr_t_must_fit_in_ecma_value_t);

#else /* !ECMA_VALUE_CAN_STORE_UINTPTR_VALUE_DIRECTLY */

JJS_STATIC_ASSERT (sizeof (uintptr_t) > sizeof (ecma_value_t), uintptr_t_must_not_fit_in_ecma_value_t);

#endif /* ECMA_VALUE_CAN_STORE_UINTPTR_VALUE_DIRECTLY */

JJS_STATIC_ASSERT ((ECMA_VALUE_FALSE | (1 << ECMA_DIRECT_SHIFT)) == ECMA_VALUE_TRUE
...
JJS_STATIC_ASSERT (ECMA_NULL_POINTER == (ECMA_BIGINT_ZERO & ~(ecma_value_t) ECMA_VALUE_TYPE_MASK),
 ...
 * @return type field
 */
extern inline ecma_type_t JJS_ATTR_CONST JJS_ATTR_ALWAYS_INLINE
                            ...
                            const void *ptr) /**< pointer */
{
  ...
  JJS_ASSERT ((uint_ptr & ECMA_VALUE_TYPE_MASK) == 0);
 ...
 *         false - otherwise
 */
extern inline bool JJS_ATTR_CONST JJS_ATTR_ALWAYS_INLINE
 ...
 *         false - otherwise
 */
static inline bool JJS_ATTR_CONST JJS_ATTR_ALWAYS_INLINE
...
{
  JJS_STATIC_ASSERT (ECMA_DIRECT_TYPE_INTEGER_VALUE == 0, ecma_direct_type_integer_value_must_be_zero);
...
JJS_STATIC_ASSERT ((ECMA_TYPE_STRING | 0x4) == ECMA_TYPE_DIRECT_STRING,
...
{
  JJS_ASSERT (ecma_is_value_undefined (value) || ecma_is_value_null (value) || ecma_is_value_boolean (value)
 ...
 */
extern inline ecma_value_t JJS_ATTR_CONST JJS_ATTR_ALWAYS_INLINE
...
{
  JJS_ASSERT (ECMA_IS_INTEGER_NUMBER (integer_value));
...
#if JJS_BUILTIN_BIGINT
  JJS_ASSERT (primitve_p != ECMA_BIGINT_POINTER_TO_ZERO);
#endif /* JJS_BUILTIN_BIGINT */
 ...
 */
extern inline ecma_integer_value_t JJS_ATTR_CONST JJS_ATTR_ALWAYS_INLINE
ecma_get_integer_from_value (ecma_value_t value) /**< ecma value */
{
  JJS_ASSERT (ecma_is_value_integer_number (value));
...
{
  JJS_ASSERT (ecma_is_value_boolean (value));
