...
ecma_value_t JJS_ATTR_PURE ecma_make_string_value (const ecma_string_t *ecma_string_p);
ecma_value_t JJS_ATTR_PURE ecma_make_symbol_value (const ecma_string_t *ecma_symbol_p);
ecma_value_t JJS_ATTR_PURE ecma_make_prop_name_value (const ecma_string_t *ecma_prop_name_p);
ecma_value_t JJS_ATTR_PURE ecma_make_magic_string_value (lit_magic_string_id_t id);
ecma_value_t JJS_ATTR_PURE ecma_make_object_value (const ecma_object_t *object_p);
ecma_value_t JJS_ATTR_PURE ecma_make_extended_primitive_value (const ecma_extended_primitive_t *primitve_p,
                                                                 uint32_t type);
ecma_integer_value_t JJS_ATTR_CONST ecma_get_integer_from_value (ecma_value_t value);
ecma_number_t JJS_ATTR_PURE ecma_get_float_from_value (ecma_value_t value);
ecma_number_t *ecma_get_pointer_from_float_value (ecma_value_t value);
ecma_number_t JJS_ATTR_PURE ecma_get_number_from_value (ecma_value_t value);
ecma_string_t JJS_ATTR_PURE *ecma_get_string_from_value (ecma_value_t value);
ecma_string_t JJS_ATTR_PURE *ecma_get_symbol_from_value (ecma_value_t value);
ecma_string_t JJS_ATTR_PURE *ecma_get_prop_name_from_value (ecma_value_t value);
ecma_object_t JJS_ATTR_PURE *ecma_get_object_from_value (ecma_value_t value);
ecma_extended_primitive_t JJS_ATTR_PURE *ecma_get_extended_primitive_from_value (ecma_value_t value);
...
lit_utf8_size_t JJS_ATTR_WARN_UNUSED_RESULT ecma_string_copy_to_buffer (const ecma_string_t *string_desc_p,
...
ecma_object_t JJS_ATTR_PURE *ecma_get_lex_env_binding_object (const ecma_object_t *object_p);
...
ecma_native_pointer_t *ecma_get_native_pointer_value (ecma_object_t *obj_p,
                                                      const jjs_object_native_info_t *native_info_p);
bool ecma_delete_native_pointer_property (ecma_object_t *obj_p, const jjs_object_native_info_t *native_info_p);
