...
ecma_lcache_invalidate_entry (ecma_lcache_hash_entry_t *entry_p) /**< entry to invalidate */
{
  ...
  JJS_ASSERT (entry_p->id != 0);
  JJS_ASSERT (entry_p->prop_p != NULL);
                    ...
                    ecma_property_t *prop_p) /**< property */
{
  ...
  JJS_ASSERT (prop_p != NULL && !ecma_is_property_lcached (prop_p));
                    ...
                    const ecma_string_t *prop_name_p) /**< property's name */
{
  ...
  if (JJS_UNLIKELY (ECMA_IS_DIRECT_STRING (prop_name_p)))
  {
  ...
  do
  {
    if (entry_p->id == id && JJS_LIKELY (ECMA_PROPERTY_GET_NAME_TYPE (*entry_p->prop_p) == prop_name_type))
    {
      JJS_ASSERT (entry_p->prop_p != NULL && ecma_is_property_lcached (entry_p->prop_p));
                        ...
                        ecma_property_t *prop_p) /**< property */
{
  ...
  while (true)
  {
    ...
    {
      JJS_ASSERT (entry_p->id == ECMA_LCACHE_CREATE_ID (object_cp, name_cp));
