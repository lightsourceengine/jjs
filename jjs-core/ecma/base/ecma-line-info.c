...
JJS_STATIC_ASSERT ((ECMA_LINE_INFO_COLUMN_DEFAULT - 1) == ((ECMA_LINE_INFO_ENCODE_TWO_BYTE >> 1) - 1),
...
ecma_line_info_decode_small (uint8_t **buffer_p) /**< [in/out] target buffer */
{
  ...
  *buffer_p = source_p + 1;
  ...
  JJS_ASSERT (type == ECMA_LINE_INFO_ENCODE_VLQ);
...
ecma_line_info_get (uint8_t *line_info_p, /**< line info buffer */
                    ...
                    jjs_frame_location_t *location_p) /**< [out] location */
{
  uint32_t line = 1;
