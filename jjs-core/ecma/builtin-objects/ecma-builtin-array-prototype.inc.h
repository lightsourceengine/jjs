...
ROUTINE (LIT_MAGIC_STRING_FIND_LAST, ECMA_ARRAY_PROTOTYPE_FIND_LAST, 2, 1)
ROUTINE (LIT_MAGIC_STRING_FIND_LAST_INDEX, ECMA_ARRAY_PROTOTYPE_FIND_LAST_INDEX, 2, 1)
ROUTINE (LIT_MAGIC_STRING_WITH, ECMA_ARRAY_PROTOTYPE_WITH, 2, 2)
ROUTINE (LIT_MAGIC_STRING_TO_REVERSED, ECMA_ARRAY_PROTOTYPE_TO_REVERSED, 0, 0)
ROUTINE (LIT_MAGIC_STRING_TO_SORTED, ECMA_ARRAY_PROTOTYPE_TO_SORTED, 1, 1)
ROUTINE (LIT_MAGIC_STRING_TO_SPLICED, ECMA_ARRAY_PROTOTYPE_TO_SPLICED, 2, 2)
