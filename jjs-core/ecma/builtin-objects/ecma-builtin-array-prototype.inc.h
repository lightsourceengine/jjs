...
ROUTINE (LIT_MAGIC_STRING_WITH, ECMA_ARRAY_PROTOTYPE_WITH, 2, 1)
ROUTINE (LIT_MAGIC_STRING_TO_REVERSED, ECMA_ARRAY_PROTOTYPE_TO_REVERSED, 0, 1)
ROUTINE (LIT_MAGIC_STRING_TO_SPLICED, ECMA_ARRAY_PROTOTYPE_TO_SPLICED, 2, 1)
