 ...
 */
ecma_value_t
ecma_builtin_async_function_dispatch_call (ecma_context_t *context_p, /**< JJS context */
                                           const ecma_value_t *arguments_list_p, /**< arguments list */
                                           uint32_t arguments_list_len) /**< number of arguments */
{
  JJS_ASSERT (arguments_list_len == 0 || arguments_list_p != NULL);

  return ecma_op_create_dynamic_function (context_p, arguments_list_p, arguments_list_len, ECMA_PARSE_ASYNC_FUNCTION);
 ...
 */
ecma_value_t
ecma_builtin_async_function_dispatch_construct (ecma_context_t *context_p, /**< JJS context */
                                                const ecma_value_t *arguments_list_p, /**< arguments list */
                                                uint32_t arguments_list_len) /**< number of arguments */
{
  return ecma_builtin_async_function_dispatch_call (context_p, arguments_list_p, arguments_list_len);
