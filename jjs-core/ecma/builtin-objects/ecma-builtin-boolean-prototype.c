                                                ...
                                                ecma_value_t this_arg) /**< this argument */
{
  ...
  else if (ecma_is_value_object (this_arg))
  {
    ...
    if (ecma_object_class_is (object_p, ECMA_OBJECT_CLASS_BOOLEAN))
    {
      ...
      JJS_ASSERT (ecma_is_value_boolean (ext_object_p->u.cls.u3.value));
                                                 ...
                                                 uint32_t arguments_number) /**< length of arguments' list */
{
  ...
  JJS_ASSERT (builtin_routine_id == ECMA_BOOLEAN_PROTOTYPE_ROUTINE_TO_STRING);
  ...
  JJS_ASSERT (ecma_is_value_false (value_of_ret));
