                                          ...
                                          uint32_t arguments_number) /**< length of arguments' list */
{
  ...
  switch (builtin_routine_id)
  {
    ...
    default:
    {
      JJS_ASSERT (builtin_routine_id == ECMA_DATE_PROTOTYPE_SET_HOURS
  ...
  if (builtin_routine_id <= ECMA_DATE_PROTOTYPE_SET_UTC_DATE)
  {
    ...
    switch (builtin_routine_id)
    {
      ...
      default:
      {
        JJS_ASSERT (builtin_routine_id == ECMA_DATE_PROTOTYPE_SET_DATE
  ...
  else
  {
    ...
    switch (builtin_routine_id)
    {
      ...
      default:
      {
        JJS_ASSERT (builtin_routine_id == ECMA_DATE_PROTOTYPE_SET_UTC_MILLISECONDS
