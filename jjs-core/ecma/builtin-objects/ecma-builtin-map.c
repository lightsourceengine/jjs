 ...
 */
ecma_value_t
ecma_builtin_map_dispatch_call (ecma_context_t *context_p, /**< JJS context */
                                const ecma_value_t *arguments_list_p, /**< arguments list */
                                uint32_t arguments_list_len) /**< number of arguments */
{
  JJS_ASSERT (arguments_list_len == 0 || arguments_list_p != NULL);

  return ecma_raise_type_error (context_p, ECMA_ERR_CONSTRUCTOR_MAP_REQUIRES_NEW);
 ...
 */
ecma_value_t
ecma_builtin_map_dispatch_construct (ecma_context_t *context_p, /**< JJS context */
                                     const ecma_value_t *arguments_list_p, /**< arguments list */
                                     uint32_t arguments_list_len) /**< number of arguments */
{
 ...
 */
ecma_value_t
ecma_builtin_map_species_get (ecma_context_t *context_p, /**< JJS context */
