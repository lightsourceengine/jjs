 ...
 */
static ecma_value_t
ecma_builtin_set_iterator_prototype_object_next (ecma_context_t *context_p, /**< JJS context */
                                                 ecma_value_t this_val) /**< this argument */
{
  return ecma_op_container_iterator_next (context_p, this_val, ECMA_OBJECT_CLASS_SET_ITERATOR);
} /* ecma_builtin_set_iterator_prototype_object_next */
 ...
 */
ecma_value_t
ecma_builtin_set_iterator_prototype_dispatch_routine (ecma_context_t *context_p, /**< JJS context */
                                                      ...
                                                      uint32_t arguments_number) /**< length of arguments' list */
{
  ...
  switch (builtin_routine_id)
  {
    ...
    {
      return ecma_builtin_set_iterator_prototype_object_next (context_p, this_arg);
    }
    default:
    {
      JJS_UNREACHABLE ();
