...
ROUTINE (LIT_MAGIC_STRING_IS_WELL_FORMED, ECMA_STRING_PROTOTYPE_IS_WELL_FORMED, 0, 0)
ROUTINE (LIT_MAGIC_STRING_TO_WELL_FORMED, ECMA_STRING_PROTOTYPE_TO_WELL_FORMED, 0, 0)
