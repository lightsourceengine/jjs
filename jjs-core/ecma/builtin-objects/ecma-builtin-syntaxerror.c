 ...
 */
ecma_value_t
ecma_builtin_syntax_error_dispatch_call (ecma_context_t *context_p, /**< JJS context */
                                         const ecma_value_t *arguments_list_p, /**< arguments list */
                                         uint32_t arguments_list_len) /**< number of arguments */
{
  return ecma_builtin_helper_error_dispatch_call (context_p, JJS_ERROR_SYNTAX, arguments_list_p, arguments_list_len);
 ...
 */
ecma_value_t
ecma_builtin_syntax_error_dispatch_construct (ecma_context_t *context_p, /**< JJS context */
                                              const ecma_value_t *arguments_list_p, /**< arguments list */
                                              uint32_t arguments_list_len) /**< number of arguments */
{
  ...
  ecma_value_t result = ecma_builtin_syntax_error_dispatch_call (context_p, arguments_list_p, arguments_list_len);
