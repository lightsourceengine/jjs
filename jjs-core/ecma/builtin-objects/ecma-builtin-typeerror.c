...
{
  return ecma_builtin_helper_error_dispatch_call (JJS_ERROR_TYPE, arguments_list_p, arguments_list_len);
                                            ...
                                            uint32_t arguments_list_len) /**< number of arguments */
{
  ecma_object_t *proto_p =
    ecma_op_get_prototype_from_constructor (JJS_CONTEXT (current_new_target_p), ECMA_BUILTIN_ID_TYPE_ERROR_PROTOTYPE);
