...
JJS_STATIC_ASSERT (ECMA_BUILTIN_ID_GLOBAL == ECMA_BUILTIN_OBJECTS_COUNT,
 ...
 */
JJS_STATIC_ASSERT (ECMA_BUILTIN_EXTENSIBLE_CHECK == true,
                          ...
                          ecma_builtin_id_t obj_builtin_id) /**< built-in id */
{
  ...
  JJS_ASSERT (obj_builtin_id < ECMA_BUILTIN_OBJECTS_COUNT);
  JJS_ASSERT (builtin_objects[obj_builtin_id] == JMEM_CP_NULL);
  ...
  if (JJS_UNLIKELY (object_prototype_builtin_id == ECMA_BUILTIN_ID__COUNT))
  {
  ...
  JJS_ASSERT (obj_type == ECMA_OBJECT_TYPE_BUILT_IN_GENERAL || obj_type == ECMA_OBJECT_TYPE_BUILT_IN_CLASS
  ...
  if (property_count > ECMA_BUILTIN_INSTANTIATED_BITSET_MIN_SIZE)
  {
    ...
    JJS_ASSERT (property_count <= (ECMA_BUILTIN_INSTANTIATED_BITSET_MIN_SIZE + 64));
  ...
  switch (obj_builtin_id)
  {
    ...
    {
      JJS_ASSERT (obj_type == ECMA_OBJECT_TYPE_BUILT_IN_ARRAY);
    ...
    {
      JJS_ASSERT (obj_type == ECMA_OBJECT_TYPE_BUILT_IN_CLASS);
      ecma_extended_object_t *ext_object_p = (ecma_extended_object_t *) obj_p;
...
ecma_builtin_create_global_object (void)
{
  ...
  JJS_ASSERT (prototype_builtin_id != ECMA_BUILTIN_ID__COUNT);
  JJS_ASSERT (obj_type == ECMA_OBJECT_TYPE_BUILT_IN_GENERAL);
                                                  ...
                                                  ecma_string_t *property_name_p) /**< property name */
{
  ...
  if (ecma_string_is_length (property_name_p))
  {
    ...
    else if (!(ext_func_p->u.built_in.u2.routine_flags & ECMA_BUILTIN_ROUTINE_GETTER))
    {
      ...
      JJS_ASSERT (property_list_p[routine_index].type == ECMA_BUILTIN_PROPERTY_ROUTINE);
  ...
  if (ecma_compare_ecma_string_to_magic_id (property_name_p, LIT_MAGIC_STRING_NAME))
  {
    ...
    if (JJS_UNLIKELY (name_id > LIT_NON_INTERNAL_MAGIC_STRING__COUNT))
    {
      ...
      if (JJS_UNLIKELY (name_id == LIT_INTERNAL_MAGIC_STRING_ARRAY_PROTOTYPE_VALUES)
          || JJS_UNLIKELY (name_id == LIT_INTERNAL_MAGIC_STRING_TYPEDARRAY_PROTOTYPE_VALUES)
          || JJS_UNLIKELY (name_id == LIT_INTERNAL_MAGIC_STRING_SET_PROTOTYPE_VALUES))
      {
        name_p = ecma_get_magic_string (LIT_MAGIC_STRING_VALUES);
      }
      else if (JJS_UNLIKELY (name_id == LIT_INTERNAL_MAGIC_STRING_MAP_PROTOTYPE_ENTRIES))
      {
                                          ...
                                          ecma_string_t *property_name_p) /**< property's name */
{
  ...
  if (JJS_UNLIKELY (ecma_prop_name_is_symbol (property_name_p)) && property_name_p->u.hash & ECMA_SYMBOL_FLAG_GLOBAL)
  {
  ...
  switch (curr_property_p->type)
  {
    ...
    case ECMA_BUILTIN_PROPERTY_NUMBER:
    {
      ...
      else
      {
        switch (curr_property_p->value)
        {
          ...
          default:
          {
            JJS_ASSERT (curr_property_p->value == ECMA_BUILTIN_NUMBER_NAN);
    ...
    default:
    {
      JJS_ASSERT (curr_property_p->type == ECMA_BUILTIN_PROPERTY_ACCESSOR_READ_ONLY);
  ...
  JJS_ASSERT (curr_property_p->attributes & ECMA_PROPERTY_FLAG_BUILT_IN);
                                                      ...
                                                      ecma_string_t *property_name_p) /**< property name */
{
  ...
  {
    JJS_ASSERT (!(extended_obj_p->u.built_in.u2.routine_flags & ECMA_NATIVE_HANDLER_FLAGS_LENGTH_INITIALIZED));
  ...
  JJS_ASSERT (!(extended_obj_p->u.built_in.u2.routine_flags & ECMA_NATIVE_HANDLER_FLAGS_NAME_INITIALIZED));
                                               ...
                                               ecma_string_t *property_name_p) /**< property name */
{
  ...
  if (JJS_UNLIKELY (extended_obj_p->u.built_in.id == ECMA_BUILTIN_ID_HANDLER))
  {
  ...
  if (ecma_compare_ecma_string_to_magic_id (property_name_p, LIT_MAGIC_STRING_LENGTH))
  {
    JJS_ASSERT (!(*bitset_p & ECMA_BUILTIN_ROUTINE_LENGTH_INITIALIZED));
  ...
  JJS_ASSERT (ecma_compare_ecma_string_to_magic_id (property_name_p, LIT_MAGIC_STRING_NAME));
  JJS_ASSERT (!(*bitset_p & ECMA_BUILTIN_ROUTINE_NAME_INITIALIZED));
                                       ...
                                       ecma_string_t *property_name_p) /**< property name */
{
  ...
  while (curr_property_p->magic_string_id != magic_string_id)
  {
    JJS_ASSERT (curr_property_p->magic_string_id != LIT_MAGIC_STRING__COUNT);
    curr_property_p++;
  }
  ...
  uint8_t bit_for_index = (uint8_t) (1u << (index & 0x7));
  JJS_ASSERT (!(*bitset_p & bit_for_index));
                                       ...
                                       jjs_property_filter_t filter) /**< name filters */
{
  ...
  if (!(filter & JJS_PROPERTY_FILTER_EXCLUDE_STRINGS))
  {
    ...
    while (curr_property_p->magic_string_id != LIT_MAGIC_STRING__COUNT)
    {
      ...
      if (!(bitset & bit_for_index))
      {
        ...
        {
          JJS_ASSERT (LIT_IS_GLOBAL_SYMBOL (curr_property_p->magic_string_id));
          has_symbol = true;
        }
      }
  ...
  if (has_symbol && !(filter & JJS_PROPERTY_FILTER_EXCLUDE_SYMBOLS))
  {
    const ecma_builtin_property_descriptor_t *curr_property_p = ecma_builtin_property_list_references[builtin_id];
    uint8_t bitset = built_in_props_p->u2.instantiated_bitset[0];
    uint32_t index = 0;
                               ...
                               uint32_t arguments_list_len) /**< length of arguments' list */
{
  ...
  if (arguments_list_len <= 2)
  {
    switch (arguments_list_len)
    {
      ...
      default:
      {
        JJS_ASSERT (arguments_list_len == 0);
      }
    }
