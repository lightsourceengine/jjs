...
ROUTINE (LIT_MAGIC_STRING_TO_REVERSED, ECMA_TYPEDARRAY_PROTOTYPE_ROUTINE_TO_REVERSED, 0, 1)
ROUTINE (LIT_MAGIC_STRING_WITH, ECMA_TYPEDARRAY_PROTOTYPE_ROUTINE_WITH, 2, 1)
