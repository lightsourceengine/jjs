...
ROUTINE (LIT_MAGIC_STRING_FIND_LAST, ECMA_TYPEDARRAY_PROTOTYPE_ROUTINE_FIND_LAST, 2, 1)
ROUTINE (LIT_MAGIC_STRING_FIND_LAST_INDEX, ECMA_TYPEDARRAY_PROTOTYPE_ROUTINE_FIND_LAST_INDEX, 2, 1)
...
ROUTINE (LIT_MAGIC_STRING_TO_REVERSED, ECMA_TYPEDARRAY_PROTOTYPE_ROUTINE_TO_REVERSED, 0, 0)
ROUTINE (LIT_MAGIC_STRING_TO_SORTED, ECMA_TYPEDARRAY_PROTOTYPE_ROUTINE_TO_SORTED, 1, 1)
ROUTINE (LIT_MAGIC_STRING_WITH, ECMA_TYPEDARRAY_PROTOTYPE_ROUTINE_WITH, 2, 2)
