 ...
 */
ecma_value_t
ecma_builtin_uint32array_dispatch_call (ecma_context_t *context_p, /**< JJS context */
                                        const ecma_value_t *arguments_list_p, /**< arguments list */
                                        uint32_t arguments_list_len) /**< number of arguments */
{
  JJS_ASSERT (arguments_list_len == 0 || arguments_list_p != NULL);

  return ecma_raise_type_error (context_p, ECMA_ERR_CONSTRUCTOR_UINT32_ARRAY_REQUIRES_NEW);
 ...
 */
ecma_value_t
ecma_builtin_uint32array_dispatch_construct (ecma_context_t *context_p, /**< JJS context */
                                             const ecma_value_t *arguments_list_p, /**< arguments list */
                                             uint32_t arguments_list_len) /**< number of arguments */
{
  JJS_ASSERT (arguments_list_len == 0 || arguments_list_p != NULL);

  return ecma_typedarray_helper_dispatch_construct (context_p, arguments_list_p, arguments_list_len, ECMA_UINT32_ARRAY);
