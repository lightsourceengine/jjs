                                ...
                                uint32_t length) /**< length of the arraybuffer */
{
  ...
  JJS_ASSERT (type == ECMA_OBJECT_CLASS_ARRAY_BUFFER || type == ECMA_OBJECT_CLASS_SHARED_ARRAY_BUFFER);
  ...
  JJS_ASSERT (type == ECMA_OBJECT_CLASS_ARRAY_BUFFER);
                                  ...
                                  ecma_object_t *arraybuffer_p) /**< ArrayBuffer object */
{
  ...
  {
    jjs_arraybuffer_type_t type = JJS_ARRAYBUFFER_TYPE_ARRAYBUFFER;

#if JJS_BUILTIN_SHAREDARRAYBUFFER
    if (extended_object_p->u.cls.type == ECMA_OBJECT_CLASS_SHARED_ARRAY_BUFFER)
    {
      type = JJS_ARRAYBUFFER_TYPE_SHARED_ARRAYBUFFER;
    }
#endif /* JJS_BUILTIN_SHAREDARRAYBUFFER */
