...
ecma_value_t ecma_validate_shared_integer_typedarray (ecma_context_t *context_p, ecma_value_t typedarray, bool waitable);
ecma_value_t ecma_validate_atomic_access (ecma_context_t *context_p, ecma_value_t typedarray, ecma_value_t request_index);
ecma_value_t
ecma_atomic_read_modify_write (ecma_context_t *context_p, ecma_value_t typedarray, ecma_value_t index, ecma_value_t value, ecma_atomics_op_t op);
ecma_value_t ecma_atomic_load (ecma_context_t *context_p, ecma_value_t typedarray, ecma_value_t index);
/**
 * @}
 * @}
 */
