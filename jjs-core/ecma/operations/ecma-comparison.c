                                   ...
                                   ecma_value_t y) /**< second operand */
{
  ...
  if (ecma_is_value_number (x))
  {
    if (ecma_is_value_number (y))
    {
      ...
      JJS_ASSERT (is_x_equal_to_y == is_x_equal_to_y_check);
#endif /* !JJS_NDEBUG */
  ...
  if (JJS_UNLIKELY (ecma_is_value_bigint (x)))
  {
  ...
  if (JJS_UNLIKELY (ecma_is_value_symbol (x)))
  {
  ...
  JJS_ASSERT (ecma_is_value_object (x));
                                 ...
                                 ecma_value_t y) /**< second operand */
{
  ...
  {
    JJS_ASSERT (!ecma_is_value_direct (x) || ecma_is_value_undefined (x) || ecma_is_value_null (x)
                  || ecma_is_value_boolean (x) || ecma_is_value_integer_number (x));

    JJS_ASSERT (!ecma_is_value_direct (y) || ecma_is_value_undefined (y) || ecma_is_value_null (y)
  ...
  JJS_ASSERT (ecma_is_value_number (x) || ecma_is_value_string (x) || ecma_is_value_bigint (x));
  JJS_ASSERT (ecma_is_value_number (y) || ecma_is_value_string (y) || ecma_is_value_bigint (y));
                                     ...
                                     bool left_first) /**< 'LeftFirst' flag */
{
  ...
  {
#if JJS_BUILTIN_BIGINT
    if (JJS_LIKELY (!ecma_is_value_bigint (px)) && JJS_LIKELY (!ecma_is_value_bigint (py)))
    {
#endif /* JJS_BUILTIN_BIGINT */
      /* 3. */
      ...
      else
      {
        ...
        {
          /* l. */
          JJS_ASSERT (!ecma_number_is_nan (nx) && !ecma_number_is_infinity (nx));
          JJS_ASSERT (!ecma_number_is_nan (ny) && !ecma_number_is_infinity (ny));
          JJS_ASSERT (!(ecma_number_is_zero (nx) && ecma_number_is_zero (ny)));
        ...
        JJS_ASSERT (is_x_less_than_y_check == is_x_less_than_y);
#endif /* !JJS_NDEBUG */
    ...
    else
    {
      ...
      JJS_ASSERT (ecma_is_value_bigint (px));
