                          ...
                          ecma_builtin_id_t proto_id) /**< prototype builtin id */
{
  ...
  ecma_object_t *proto_p = ecma_op_get_prototype_from_constructor (JJS_CONTEXT (current_new_target_p), proto_id);
                              ...
                              lit_magic_string_id_t lit_id) /**< internal class id */
{
  ...
  ecma_raise_standard_error_with_format (JJS_ERROR_TYPE,
                                         "Expected a % object",
