                    ...
                    ecma_value_t y) /**< ecma value */
{
  ...
  JJS_ASSERT (ecma_is_value_object (x) || ecma_is_value_symbol (x));
                    ...
                    ecma_value_t value) /**< ecma value */
{
  ...
  {
    JJS_ASSERT (ecma_is_value_boolean (value) || ecma_is_value_undefined (value) || ecma_is_value_null (value));
  ...
  JJS_ASSERT (ecma_is_value_object (value) || ecma_is_value_symbol (value));
                                  ...
                                  const ecma_property_descriptor_t *src_prop_desc_p) /**< property descriptor */
{
  ...
  {
    prop_desc.flags = (JJS_PROP_IS_VALUE_DEFINED | JJS_PROP_IS_WRITABLE_DEFINED | JJS_PROP_IS_WRITABLE
                       | JJS_PROP_IS_ENUMERABLE_DEFINED | JJS_PROP_IS_ENUMERABLE
                       | JJS_PROP_IS_CONFIGURABLE_DEFINED | JJS_PROP_IS_CONFIGURABLE);
  }

  /* 3. */
  if (src_prop_desc_p->flags & (JJS_PROP_IS_VALUE_DEFINED | JJS_PROP_IS_WRITABLE_DEFINED))
  {
    JJS_ASSERT ((prop_desc.flags & (JJS_PROP_IS_VALUE_DEFINED | JJS_PROP_IS_WRITABLE_DEFINED))
                  == (JJS_PROP_IS_VALUE_DEFINED | JJS_PROP_IS_WRITABLE_DEFINED));
                                                                              ...
                                                                              *   unmodified otherwise */
{
  ...
  if (ecma_is_value_found (get_prop_value))
  {
    ...
    prop_desc.flags |= JJS_PROP_IS_GET_DEFINED;
  ...
  if (ecma_is_value_found (set_prop_value))
  {
    ...
    prop_desc.flags |= JJS_PROP_IS_SET_DEFINED;
...
{
  /* 1. */
  JJS_ASSERT (!ECMA_IS_VALUE_ERROR (arr));
