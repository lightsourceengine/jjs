...
ecma_object_t *ecma_new_standard_error (ecma_context_t *context_p, jjs_error_t error_type, ecma_string_t *message_string_p);
ecma_object_t *ecma_new_standard_error_with_options (ecma_context_t *context_p, jjs_error_t error_type, ecma_string_t *message_string_p, ecma_value_t options_val);

#if JJS_ERROR_MESSAGES
ecma_value_t ecma_raise_standard_error_with_format (ecma_context_t *context_p, jjs_error_t error_type, const char *msg_p, ...);
#endif /* JJS_ERROR_MESSAGES */
ecma_value_t ecma_raise_standard_error (ecma_context_t *context_p, jjs_error_t error_type, ecma_error_msg_t msg);
ecma_value_t ecma_raise_common_error (ecma_context_t *context_p, ecma_error_msg_t msg);
ecma_value_t ecma_raise_range_error (ecma_context_t *context_p, ecma_error_msg_t msg);
ecma_value_t ecma_raise_reference_error (ecma_context_t *context_p, ecma_error_msg_t msg);
