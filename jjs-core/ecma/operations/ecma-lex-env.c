...
#endif /* JJS_BUILTIN_PROXY && JJS_BUILTIN_REALMS */
                             ...
                             bool is_strict) /**< argument S */
{
  ...
  switch (ecma_get_lex_env_type (lex_env_p))
  {
    ...
    case ECMA_LEXICAL_ENVIRONMENT_DECLARATIVE:
    {
      ...
      JJS_ASSERT (!(*property_p & ECMA_PROPERTY_FLAG_WRITABLE) || (*property_p & ECMA_PROPERTY_FLAG_DATA));
                        ...
                        ecma_string_t *name_p) /**< argument N */
{
  ...
  if (ecma_get_lex_env_type (lex_env_p) == ECMA_LEXICAL_ENVIRONMENT_DECLARATIVE)
  {
    ...
    {
      JJS_ASSERT (ECMA_PROPERTY_IS_RAW_DATA (*prop_p));
...
{
  JJS_ASSERT (environment_record_p != NULL);
  JJS_ASSERT (ecma_is_value_object (this_binding));
  JJS_ASSERT (!ecma_op_this_binding_is_initialized (environment_record_p));
