 ...
 */
#ifndef JJS_NDEBUG
#define JJS_ASSERT_OBJECT_TYPE_IS_VALID(type) JJS_ASSERT (type < ECMA_OBJECT_TYPE__MAX);
#else /* JJS_NDEBUG */
#define JJS_ASSERT_OBJECT_TYPE_IS_VALID(type)
#endif /* !JJS_NDEBUG */
                                 ...
                                 uint32_t options) /**< option bits */
{
  ...
  JJS_ASSERT (options == ECMA_PROPERTY_GET_NO_OPTIONS || property_ref_p != NULL);
    ...
    case ECMA_OBJECT_BASE_TYPE_CLASS:
    {
      ...
      switch (ext_object_p->u.cls.type)
      {
        ...
        case ECMA_OBJECT_CLASS_TYPEDARRAY:
        {
          ...
          if (JJS_UNLIKELY (ecma_is_value_undefined (value)))
          {
    ...
    if (index < ext_object_p->u.cls.u2.formal_params_number)
    {
      ...
      if (!ecma_is_value_empty (argv_p[index]) && argv_p[index] != ECMA_VALUE_ARGUMENT_NO_TRACK)
      {
        ...
        if (ecma_is_property_lcached (property_p))
        {
          ...
          if (JJS_UNLIKELY (ECMA_IS_DIRECT_STRING (property_name_p)))
          {
                             ...
                             ecma_string_t *property_name_p) /**< property name */
{
  while (true)
  {
    ...
    if (property != ECMA_PROPERTY_TYPE_NOT_FOUND)
    {
      ...
      JJS_ASSERT (property == ECMA_PROPERTY_TYPE_NOT_FOUND_AND_STOP || ECMA_PROPERTY_IS_FOUND (property));
  ...
  switch (base_type)
  {
    ...
    case ECMA_OBJECT_BASE_TYPE_ARRAY:
    {
      ...
      if (JJS_LIKELY (ecma_op_array_is_fast_array (ext_object_p)))
      {
        ...
        if (JJS_LIKELY (index != ECMA_STRING_NOT_ARRAY_INDEX))
        {
          if (JJS_LIKELY (index < ext_object_p->u.array.length))
          {
            ecma_value_t *values_p = ECMA_GET_NON_NULL_POINTER (context_p, ecma_value_t, object_p->u1.property_list_cp);
...
JJS_STATIC_ASSERT (sizeof (ecma_global_symbol_descriptions) / sizeof (uint16_t) == ECMA_BUILTIN_GLOBAL_SYMBOL_COUNT,
                                   ...
                                   bool is_throw) /**< flag that controls failure handling */
{
  ...
  if (ECMA_OBJECT_IS_PROXY (receiver_obj_p))
  {
    ...
    desc.flags = (JJS_PROP_IS_CONFIGURABLE | JJS_PROP_IS_CONFIGURABLE_DEFINED | JJS_PROP_IS_ENUMERABLE
                                  ...
                                  bool is_throw) /**< flag that controls failure handling */
{
  ...
  else
  {
    ...
    while (true)
    {
      ...
      {
        JJS_ASSERT (ECMA_PROPERTY_IS_NAMED_PROPERTY (inherited_property));
      ...
      JJS_ASSERT (inherited_property == ECMA_PROPERTY_TYPE_NOT_FOUND
                                            ...
                                            ecma_property_descriptor_t *prop_desc_p) /**< property descriptor */
{
  *prop_desc_p = ecma_make_empty_property_descriptor ();
  ...
  uint32_t flags = ecma_is_property_enumerable (property) ? JJS_PROP_IS_ENUMERABLE : JJS_PROP_NO_OPTS;
  flags |= ecma_is_property_configurable (property) ? JJS_PROP_IS_CONFIGURABLE : JJS_PROP_NO_OPTS;

  prop_desc_p->flags = (uint16_t) (JJS_PROP_IS_ENUMERABLE_DEFINED | JJS_PROP_IS_CONFIGURABLE_DEFINED | flags);
  ...
  if (property & ECMA_PROPERTY_FLAG_DATA)
  {
    ...
    prop_desc_p->flags |= (JJS_PROP_IS_VALUE_DEFINED | JJS_PROP_IS_WRITABLE_DEFINED);
    prop_desc_p->flags = (uint16_t) (
      prop_desc_p->flags | (ecma_is_property_writable (property) ? JJS_PROP_IS_WRITABLE : JJS_PROP_NO_OPTS));
  }
  else
  {
                                      ...
                                      jjs_property_filter_t filter) /**< property name filter options */
{
  switch (ecma_get_object_type (obj_p))
  {
    ...
    default:
    {
      JJS_ASSERT (ecma_get_object_type (obj_p) == ECMA_OBJECT_TYPE_GENERAL
                                  ...
                                  jjs_property_filter_t filter) /**< name filters */
{
  ...
  {
    JJS_ASSERT (prop_counter.array_index_named_props == 0);
    array_index_named_props = 0;
  }

  if (filter & JJS_PROPERTY_FILTER_EXCLUDE_STRINGS)
  {
    JJS_ASSERT (prop_counter.string_named_props == 0);
    string_named_props = 0;
  }

  if (filter & JJS_PROPERTY_FILTER_EXCLUDE_SYMBOLS)
  {
    JJS_ASSERT (prop_counter.symbol_named_props == 0);
...
{
  JJS_ASSERT (object_p != NULL && !ecma_is_lexical_environment (object_p));
  JJS_ASSERT (builtin_id < ECMA_BUILTIN_ID__COUNT);
...
JJS_STATIC_ASSERT (sizeof (ecma_class_object_magic_string_id) == ECMA_OBJECT_CLASS__MAX * sizeof (uint16_t),
                            ...
                            ecma_object_t *obj_p) /**< object */
{
  ...
  switch (type)
  {
    ...
    case ECMA_OBJECT_TYPE_BUILT_IN_CLASS:
    {
      ...
      JJS_ASSERT (ecma_class_object_magic_string_id[ext_object_p->u.cls.type] != LIT_MAGIC_STRING__EMPTY);
    ...
    default:
    {
      JJS_ASSERT (type == ECMA_OBJECT_TYPE_GENERAL || type == ECMA_OBJECT_TYPE_PROXY);
                                       ...
                                       ecma_object_t *object_p) /**< object */
{
  ...
  JJS_ASSERT (!ecma_op_object_is_fast_array (object_p) || is_extensible);
                                          ...
                                          ecma_string_t *property_name_p) /**< property name */
{
  ...
  JJS_ASSERT (ECMA_PROPERTY_IS_FOUND (property) || property == ECMA_PROPERTY_TYPE_NOT_FOUND
                           ...
                           ecma_value_t ref_holder) /**< key argument */
{
  ...
  while (true)
  {
    ...
    JJS_ASSERT (buffer_p < refs_p->buffer_p + refs_p->item_count);
    buffer_p++;
  }
 ...
 *
 * @return ECMA_VALUE_FALSE - if JJS_PROP_SHOULD_THROW is not set
