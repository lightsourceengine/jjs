                         ...
                         ecma_value_t result) /**< the result value */
{
  ...
  JJS_ASSERT (ext_object_p->u.cls.u3.value == ECMA_VALUE_UNDEFINED);
                                   ...
                                   bool is_inc) /**< whether to increase the count */
{
  ...
  JJS_ASSERT (ecma_is_value_integer_number (ext_object_p->u.cls.u3.value));
...
{
  JJS_ASSERT (ecma_object_class_is (result_capability_obj_p, ECMA_OBJECT_CLASS_PROMISE_CAPABILITY));
