...
{
  JJS_ASSERT (ecma_object_is_typedarray (obj_p));
                                           ...
                                           ecma_typedarray_type_t typedarray_id) /**< id of the typedarray */
{
  ...
  if (byte_length > UINT32_MAX - sizeof (ecma_extended_object_t) - JMEM_ALIGNMENT + 1)
  {
    ...
    ecma_value_t result =
      ecma_raise_standard_error_with_format (JJS_ERROR_RANGE, "Invalid typed array length: %", array_length_value);
                         ...
                         ecma_value_t this_arg) /**< this argument */
{
  JJS_UNUSED (this_arg);
  /* 3 */
  JJS_ASSERT (ecma_op_is_callable (map_fn_val) || ecma_is_value_undefined (map_fn_val));
...
{
  JJS_ASSERT (ecma_object_is_typedarray (typedarray_p));
                           ...
                           ecma_typedarray_type_t typedarray_id) /**< id of the typedarray */
{
  ...
  if (!ecma_is_value_object (arguments_list_p[0]))
  {
    ...
    {
#if JJS_ERROR_MESSAGES
      return ecma_raise_standard_error_with_format (JJS_ERROR_RANGE,
