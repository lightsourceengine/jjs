...
{
  static const lit_utf8_byte_t *const lit_magic_strings[] JJS_ATTR_CONST_DATA = {
...
#undef LIT_MAGIC_STRING_FIRST_STRING_WITH_SIZE
  ...
  JJS_ASSERT (id < LIT_NON_INTERNAL_MAGIC_STRING__COUNT);
...
{
  static const lit_magic_size_t lit_magic_string_sizes[] JJS_ATTR_CONST_DATA = {
/** @cond doxygen_suppress */
#define LIT_MAGIC_STRING_FIRST_STRING_WITH_SIZE(size, id)
...
{
  static const lit_magic_string_id_t lit_magic_string_size_block_starts[] JJS_ATTR_CONST_DATA = {
/** @cond doxygen_suppress */
...
#undef LIT_MAGIC_STRING_FIRST_STRING_WITH_SIZE
  ...
  JJS_ASSERT (size <= (sizeof (lit_magic_string_size_block_starts) / sizeof (lit_magic_string_id_t)));
                                 ...
                                 lit_utf8_size_t buffer_size) /**< size of buffer */
{
  ...
  {
    bytes_copied++;
    JJS_ASSERT (bytes_copied <= buffer_size);
