...
#if JJS_ANNEX_ESM
LIT_MAGIC_STRING_DEF (LIT_MAGIC_STRING_ESM_FILENAME_DEFAULT, "<source>")
#endif /* JJS_ANNEX_ESM */
#if JJS_BUILTIN_DATAVIEW
...
#endif /* JJS_BUILTIN_ATOMICS */
#if JJS_ANNEX_ESM
LIT_MAGIC_STRING_FIRST_STRING_WITH_SIZE (8, LIT_MAGIC_STRING_ESM_FILENAME_DEFAULT)
#elif JJS_BUILTIN_DATAVIEW
