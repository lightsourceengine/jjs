 ...
 */
#define PARSER_SAVED_FLAGS_OFFSET JJS_LOG2 (PARSER_ALLOW_SUPER)

/**
 * Mask of saved flags
 */
#define PARSER_SAVED_FLAGS_MASK \
  ((1 << (JJS_LOG2 (PARSER_ALLOW_NEW_TARGET) - JJS_LOG2 (PARSER_ALLOW_SUPER) + 1)) - 1)
 ...
 */
#define PARSER_RESTORE_STATUS_FLAGS_SHIFT (JJS_LOG2 (PARSER_ALLOW_SUPER) - JJS_LOG2 (ECMA_PARSE_ALLOW_SUPER))
 ...
 */
#define PARSER_GET_EVAL_FLAG(type) ((type) >> JJS_LOG2 (ECMA_PARSE_ALLOW_SUPER))
 ...
 */
#define PARSER_MAX_BREAKPOINT_INFO_COUNT (JJS_DEBUGGER_TRANSPORT_MAX_BUFFER_SIZE / sizeof (parser_breakpoint_info_t))
