                           ...
                           scanner_context_t *scanner_context_p) /**< scanner context */
{
  ...
  JJS_ASSERT (context_p->stack_top_uint8 == SCAN_STACK_USE_ASYNC);
                           ...
                           const uint8_t *source_p) /**< identifier end position */
{
  ...
  {
    JJS_ASSERT (scanner_context_p->async_source_p == source_p);
...
scanner_check_arrow_arg (parser_context_t *context_p, /**< context */
                         scanner_context_t *scanner_context_p) /**< scanner context */
{
  JJS_ASSERT (context_p->stack_top_uint8 == SCAN_STACK_ARROW_ARGUMENTS);
                              ...
                              scanner_context_t *scanner_context_p) /**< scanner context */
{
  ...
  JJS_ASSERT (scanner_context_p->mode == SCAN_MODE_PRIMARY_EXPRESSION
                || scanner_context_p->mode == SCAN_MODE_PRIMARY_EXPRESSION_AFTER_NEW);
  JJS_ASSERT (scanner_context_p->async_source_p != NULL);
                                 ...
                                 scanner_context_t *scanner_context_p) /**< scanner context */
{
  ...
  if (JJS_UNLIKELY (context_p->token.type == LEXER_KEYW_FUNCTION))
  {
                      ...
                      scanner_context_t *scanner_context_p) /**< scanner context */
{
  ...
  JJS_ASSERT (context_p->token.type == LEXER_LEFT_PAREN);
  ...
  if (JJS_UNLIKELY (scanner_context_p->async_source_p != NULL) && (arrow_source_p == NULL || depth > 0))
  {
    scanner_context_p->async_source_p = NULL;
  }
  ...
  {
    JJS_ASSERT (async_source_p == NULL);
    ...
    if (JJS_UNLIKELY (scanner_context_p->async_source_p != NULL))
    {
  ...
  else if (JJS_UNLIKELY (async_source_p != NULL))
  {
