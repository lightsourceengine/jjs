                          ...
                          ecma_value_t this_val) /**< this_arg of the function */
{
  ...
  JJS_ASSERT (ecma_op_is_callable (property_value_p->value));
                             ...
                             ecma_value_t filter_array) /**< filter array */
{
  ...
  ecma_collection_t *names_p = ecma_op_object_own_property_keys (source_object_p, JJS_PROPERTY_FILTER_ALL);
