...
#if defined(JJS_TEST_STACK_MEASURE) && (JJS_TEST_STACK_MEASURE)
...
#else /* (JJS_TEST_STACK_MEASURE) && (JJS_TEST_STACK_MEASURE) */
#define STACK_SAVE(TARGET)
#define STACK_INIT(TARGET, SIZE)
#define STACK_USAGE(TARGET, SIZE)
#endif /* #if defined (JJS_TEST_STACK_MEASURE) && (JJS_TEST_STACK_MEASURE) */
