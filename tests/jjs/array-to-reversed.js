...
// test: toReversed() should throw RangeError when array length is too big
assertThrows(RangeError, () => { Array.prototype.toReversed.call({length: Number.MAX_SAFE_INTEGER}); });
