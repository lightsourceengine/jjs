...
main (void)
{
  ...
  sz = jjs_string_size (args[0], JJS_ENCODING_CESU8);
  TEST_ASSERT (sz == 0);
  ...
  args[0] = jjs_string ((jjs_char_t *) utf8_bytes_p, (jjs_size_t) strlen (utf8_bytes_p), JJS_ENCODING_UTF8);
  args[1] = jjs_string ((jjs_char_t *) cesu8_bytes_p, (jjs_size_t) strlen (cesu8_bytes_p), JJS_ENCODING_CESU8);

  /* These sizes must be equal */
  utf8_sz = jjs_string_size (args[0], JJS_ENCODING_CESU8);
  ...
  jjs_string_to_buffer (args[0], JJS_ENCODING_CESU8, string_from_utf8, utf8_sz);
  jjs_string_to_buffer (args[1], JJS_ENCODING_CESU8, string_from_cesu8, cesu8_sz);
  ...
  /* These sizes must be equal */
  utf8_sz = jjs_string_size (args[0], JJS_ENCODING_UTF8);
  cesu8_sz = jjs_string_size (args[1], JJS_ENCODING_UTF8);
  ...
  jjs_string_to_buffer (args[0], JJS_ENCODING_UTF8, string_from_utf8_string, utf8_sz);
  jjs_string_to_buffer (args[1], JJS_ENCODING_UTF8, string_from_cesu8_string, cesu8_sz);
  ...
  TEST_ASSERT (jjs_string_length (args[0]) == 10);
  TEST_ASSERT (cesu8_sz != utf8_sz);
  TEST_ASSERT (utf8_sz == 14 && cesu8_sz == 18);

  JJS_VLA (char, test_string, utf8_sz);

  TEST_ASSERT (jjs_string_to_buffer (args[0], JJS_ENCODING_UTF8, (jjs_char_t *) test_string, utf8_sz) == 14);
  ...
  /* Test string: 'str: {DESERET CAPITAL LETTER LONG I}' */
  cesu8_bytes_p = "\x73\x74\x72\x3a \xed\xa0\x81\xed\xb0\x80";
  args[0] = jjs_string ((jjs_char_t *) cesu8_bytes_p, (jjs_size_t) strlen (cesu8_bytes_p), JJS_ENCODING_CESU8);

  cesu8_sz = jjs_string_size (args[0], JJS_ENCODING_CESU8);
  utf8_sz = jjs_string_size (args[0], JJS_ENCODING_UTF8);

  TEST_ASSERT (jjs_string_length (args[0]) == 7);
  TEST_ASSERT (cesu8_sz != utf8_sz);
  ...
  /* Test string: '3' */
  {
    jjs_value_t test_str = jjs_string_sz ("3");
    char result_string[1] = { 'E' };
    jjs_size_t copied_utf8 =
      jjs_string_to_buffer (test_str, JJS_ENCODING_UTF8, (jjs_char_t *) result_string, sizeof (result_string));
    TEST_ASSERT (copied_utf8 == 1);
    TEST_ASSERT (result_string[0] == '3');

    result_string[0] = 'E';
    jjs_size_t copied =
      jjs_string_to_buffer (test_str, JJS_ENCODING_CESU8, (jjs_char_t *) result_string, sizeof (result_string));
