...
static const jjs_context_data_manager_t manager1 = { .init_cb = test_context_data1_new,
...
static const jjs_context_data_manager_t manager2 = { .init_cb = test_context_data2_new,
...
{
  JJS_UNUSED (user_data_p);
  test_context_data3_new_called = true;
} /* test_context_data3_new */

static const jjs_context_data_manager_t manager3 = {
...
static const jjs_context_data_manager_t manager4 = { .init_cb = test_context_data4_new,
