...
/**
 * Unit test for jjs-ext/handle-scope-handle-prelist-escape.
 *
 * Tests escaping JJS value that holds on scope's prelist.
 */
...
static const size_t handle_count = JJSX_HANDLE_PRELIST_SIZE + 1;
