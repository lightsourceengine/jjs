...
check_double ("acos (0.5)", acos (0.5), 1.04719755119659763132E+00);
...
check_double ("acos (-7.4e-9)", acos (-7.4e-9), 1.57079633419489650414E+00);
...
check_double ("acos (-0.1)", acos (-0.1), 1.67096374795645630229E+00);
...
check_double ("asin (-1.0)", asin (-1.0), -1.57079632679489655800E+00);
check_double ("asin (0.5)", asin (0.5), 5.23598775598298815659E-01);
check_double ("asin (-0.5)", asin (-0.5), -5.23598775598298815659E-01);
...
check_double ("acosh (-0.35)", acosh (-0.35), NAN);
check_double ("acosh (1.03)", acosh (1.03), 2.44340698822827634418E-01);
...
check_double ("acosh (-3.73e-09)", acosh (-3.73e-09), NAN);
check_double ("acosh (2.0)", acosh (2.0), 1.31695789692481657340E+00);
...
check_double ("asinh (-7.40e+02)", asinh (-7.40e+02), -7.29979782329546633690E+00);
...
check_double ("atanh (0.34)", atanh (0.34), 3.54092528962242969470E-01);
check_double ("atanh (-0.34)", atanh (-0.34), -3.54092528962242969470E-01);
...
check_double ("atanh (0.7)", atanh (0.7), 8.67300527694053191574E-01);
...
check_double ("cbrt (0.7)", cbrt (0.7), 8.87904001742600756941E-01);
...
check_double ("cbrt (6642.25)", cbrt (6642.25), 1.87977155063238683397E+01);
...
check_double ("sin (-M_PI / 6.0)", sin (-M_PI / 6.0), -4.99999999999999944489E-01);
check_double ("sin (M_PI * 2.0 / 3.0)", sin (M_PI * 2.0 / 3.0), 8.66025403784438818633E-01);
check_double ("sin (-M_PI * 2.0 / 3.0)", sin (-M_PI * 2.0 / 3.0), -8.66025403784438818633E-01);
...
check_double ("sin (-6.0)", sin (-6.0), 2.79415498198925860152E-01);
check_double ("sin (7.0)", sin (7.0), 6.56986598718789172047E-01);
check_double ("sin (-7.0)", sin (-7.0), -6.56986598718789172047E-01);
...
check_double ("cos (-4.0)", cos (-4.0), -6.53643620863611940486E-01);
check_double ("cos (6.0)", cos (6.0), 9.60170286650366078263E-01);
check_double ("cos (-6.0)", cos (-6.0), 9.60170286650366078263E-01);
check_double ("cos (7.0)", cos (7.0), 7.53902254343304600859E-01);
check_double ("cos (-7.0)", cos (-7.0), 7.53902254343304600859E-01);
check_double ("tan (0.0)", tan (0.0), 0.00000000000000000000E+00);
check_double ("tan (-0.0)", tan (-0.0), -0.00000000000000000000E+00);
check_double ("tan (1.0)", tan (1.0), 1.55740772465490207033E+00);
check_double ("tan (-1.0)", tan (-1.0), -1.55740772465490207033E+00);
...
check_double ("tan (-M_PI / 4.0)", tan (-M_PI / 4.0), -9.99999999999999888978E-01);
check_double ("tan (M_PI / 6.0)", tan (M_PI / 6.0), 5.77350269189625620037E-01);
check_double ("tan (-M_PI / 6.0)", tan (-M_PI / 6.0), -5.77350269189625620037E-01);
check_double ("tan (M_PI * 2.0 / 3.0)", tan (M_PI * 2.0 / 3.0), -1.73205080756887830340E+00);
check_double ("tan (-M_PI * 2.0 / 3.0)", tan (-M_PI * 2.0 / 3.0), 1.73205080756887830340E+00);
check_double ("tan (M_PI * 5.0 / 6.0)", tan (M_PI * 5.0 / 6.0), -5.77350269189625620037E-01);
check_double ("tan (-M_PI * 5.0 / 6.0)", tan (-M_PI * 5.0 / 6.0), 5.77350269189625620037E-01);
...
check_double ("tan (-0.6)", tan (-0.6), -6.84136808341692326252E-01);
check_double ("tan (0.7)", tan (0.7), 8.42288380463079300320E-01);
check_double ("tan (-0.7)", tan (-0.7), -8.42288380463079300320E-01);
...
check_double ("tan (-6.0)", tan (-6.0), 2.91006191384749146600E-01);
check_double ("tan (7.0)", tan (7.0), 8.71447982724318892522E-01);
check_double ("tan (-7.0)", tan (-7.0), -8.71447982724318892522E-01);
