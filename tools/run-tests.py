...
JJS_BUILDOPTIONS = [
    ...
    # platform api flags
    Options('buildoption_test-no-platform_api_io_log',
            JJS_BUILDOPTIONS_COMMON + ['--platform-api-io-log=off']),
    ...
    Options('buildoption_test-no-platform_api_time_hrtime',
            JJS_BUILDOPTIONS_COMMON + ['--platform-api-time-hrtime=off']),
