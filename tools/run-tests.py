...
JJS_BUILDOPTIONS = [
    ...
    Options('buildoption_test-commonjs-off',
            ['--compile-flag=-DJJS_ANNEX_COMMONJS=0', '--lto=off']),
    Options('buildoption_test-esm-off',
            ['--compile-flag=-DJJS_ANNEX_ESM=0', '--lto=off']),
    Options('buildoption_test-commonjs-off',
            ['--compile-flag=-DJJS_ANNEX_PMAP=0', '--lto=off']),
    Options('buildoption_test-vmod-off',
            ['--compile-flag=-DJJS_ANNEX_VMOD=0', '--lto=off']),
    Options('buildoption_test-queuemicrotask-off',
            ['--compile-flag=-DJJS_ANNEX_QUEUE_MICROTASK=0', '--lto=off']),
    Options('buildoption_test-pack-esm-off',
            ['--jjs-pack=on', '--compile-flag=-DJJS_ANNEX_ESM=0', '--compile-flag=-DJJS_ANNEX_COMMONJS=0']),
